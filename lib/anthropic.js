...
// Modell per oppgave (fase 2). Bakoverkompatibel med ANTHROPIC_MODEL/-CHAT_MODEL.
export function modelName() { return process.env.BRIEF_MODEL || process.env.ANTHROPIC_MODEL || DEFAULT_MODEL; }
export function chatModelName() { return process.env.CHAT_MODEL || process.env.ANTHROPIC_CHAT_MODEL || modelName(); }
export function summaryModelName() { return process.env.SUMMARY_MODEL || modelName(); }
